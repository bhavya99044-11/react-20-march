...
const inputCellClassName = "w-full";
      ...
      <div className="mt-6 grid grid-cols-2 gap-6">
        <div className="space-y-4">
          <Input
            ...
            required={true}
            error={checkoutError.fullName}
            capitalizeWords={true}
            className={inputCellClassName}
            inputDivClassName={inputDivClassName}
          ...
          <Input
            ...
            onChange={onFieldChange}
            placeholder="bhavya@mindinventory.com"
            required={true}
            error={checkoutError.email}
            className={inputCellClassName}
            inputDivClassName={inputDivClassName}
            inputClassName={inputFieldClassName}
          />
          <Input
            ...
            onChange={onFieldChange}
            placeholder="6355431837"
            required={true}
            error={checkoutError.phone}
            className={inputCellClassName}
            inputDivClassName={inputDivClassName}
            inputClassName={inputFieldClassName}
          />
          <Input
            ...
            onChange={onFieldChange}
            placeholder="801, City-center 2 , Science City , Ahmedabad."
            required={true}
            error={checkoutError.address}
            className={inputCellClassName}
            inputDivClassName={inputDivClassName}
            inputClassName={inputFieldClassName}
          />
          <div className="grid gap-4 sm:grid-cols-3">
            <Input
              ...
              required={true}
              error={checkoutError.city}
              className={inputCellClassName}
              divClassName={inputDivClassName}
              inputClassName={inputFieldClassName}
            />
            <Input
              id="state"
              ...
              {checkoutForm.paymentMethod === "card" ? (
                <>
                  ...
                  <Input
                    ...
                    required={true}
                    error={checkoutError.cardNumber}
                    className={inputCellClassName}
                    divClassName={inputDivClassName}
                    inputClassName={inputFieldClassName}
                    inputMode="numeric"
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <Input
                      ...
                      placeholder="MM/YY"
                      required={true}
                      error={checkoutError.expiryDate}
                      className={inputCellClassName}
                      divClassName={inputDivClassName}
                      inputClassName={inputFieldClassName}
                      inputMode="numeric"
                ...
                <div className="rounded-2xl col-span-2 border border-dashed border-[color:var(--color-border-subtle)] bg-slate-50 px-4 py-5 text-sm text-[color:var(--color-text-secondary)] dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300">
                  Payment will be collected upon delivery.
                </div>
              )}
            </div>
            <div className="rounded-2xl mt-5 bg-[#F5F8FF] p-4 dark:bg-slate-950">
              <p className="text-sm font-semibold text-[color:var(--color-text-primary)] dark:text-slate-100">
                Delivery Estimate
              </p>
